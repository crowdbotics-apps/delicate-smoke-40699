"""
Django settings for delicate_smoke_40699 project.
...
ROOT_URLCONF = 'delicate_smoke_40699.urls'
...
WSGI_APPLICATION = 'delicate_smoke_40699.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_smoke_40699 API",
    "DESCRIPTION": "API documentation for delicate_smoke_40699 App",
    "VERSION": "v1",
}
